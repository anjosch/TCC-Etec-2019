  ...
  return ['$document', '$timeout', function($document, $timeout) {
    return {
      ...
      compile: function(tElement) {
        ...
        // top style tabs? if so, remove bottom   for seamless display
        $timeout(function() {
 ...
 * frame ="0" allowfullscreen></iframe>
 *
 ...
 * have different names, for example, SVG uses the term `stroke` instead of ` `, and
